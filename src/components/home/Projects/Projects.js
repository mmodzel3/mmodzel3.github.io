...
const projectList = [
  ...
  new Project('LostFinder Server', 'This project is a mobile application for Android that can be used to help searching of missing people.', 'https://github.com/mmodzel3/LostFinderServer', 'https://www.dariawan.com/media/images/tutorial-spring-logo.width-1024.png', "Java - Spring"),
